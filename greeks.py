...
<!-- BEGIN [include] 'inc_js_timing.txt' -->
...
<!-- END [include] 'inc_js_timing.txt' -->



<!-- BEGIN [include] 'inc_clickjacking.txt' -->

	<noscript><meta http-equiv="refresh" content="0; URL=/files/jalhadi/F4VUX102Y/greeks.py?nojsmode=1" /></noscript>
...
<!-- END [include] 'inc_clickjacking.txt' -->



	
<!-- BEGIN [include] 'inc_analytics.txt' -->
	...
	<script type="text/javascript">
		...
		sb('set', 'token', '3307f436963e02d4f9eb85ce5159744c');
					...
					sb('set', 'user_id', "U4J0Z6K2T");
							sb('set', 'user_' + "batch", "immediate-launch");
							sb('set', 'user_' + "created", "2017-03-13");
						sb('set', 'name_tag', "tradingtechnologies" + '/' + "jkye96");
				sb('track', 'pageview');
...
<!-- BEGIN [include] 'inc_title.txt' -->

	    <title>greeks.py | Trading Technologies Slack</title>
    <meta name="author" content="Slack">

<!-- END [include] 'inc_title.txt' -->
...
<!-- BEGIN [include] 'inc_lato_fonts.txt' -->

					
<!-- END [include] 'inc_lato_fonts.txt' -->
			...
			<!-- output_css "core" -->
    <link href="https://a.slack-edge.com/9b43/style/rollup-plastic.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
    ...
    <link href="https://a.slack-edge.com/b1b83/style/codemirror_overrides.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">

	<!-- output_css "file_pages" -->
    <link href="https://a.slack-edge.com/60ce0/style/rollup-file_pages.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">

		<!-- output_css "regular" -->
    <link href="https://a.slack-edge.com/2683e/style/print.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
...
<!-- BEGIN [include] 'inc_favicons.txt' -->
		...
		<div id="user_menu">
			<div id="user_menu_contents">
				<div id="user_menu_avatar">
										<span class="member_image thumb_48" style="background-image: url('https://secure.gravatar.com/avatar/e72d8d3c43988e852c3a02746f3792a8.jpg?s=192&d=https%3A%2F%2Fa.slack-edge.com%2F7fa9%2Fimg%2Favatars%2Fava_0021-192.png')" data-thumb-size="48" data-member-id="U4J0Z6K2T">
	<ts-icon class="member_type_badge member_type_badge_16">
		<!-- Background for icon -->
		<svg class="member_type_badge_background_ura" width="18px" height="18px" viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
			<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
				<g id="badge_bg" fill="#FFFFFF">
					<polygon id="status---single-channel---online" points="0 17.9999995 18 18 17.9999994 0"></polygon>
				</g>
			</g>
		</svg>
		...
		<svg class="member_type_badge_icon" width="18px" height="18px" viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
			<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
				<g id="badge_ura" fill="#808183">
					...
					<span class="member_image thumb_36" style="background-image: url('https://secure.gravatar.com/avatar/e72d8d3c43988e852c3a02746f3792a8.jpg?s=72&d=https%3A%2F%2Fa.slack-edge.com%2F66f9%2Fimg%2Favatars%2Fava_0021-72.png')" data-thumb-size="36" data-member-id="U4J0Z6K2T">
	<ts-icon class="member_type_badge member_type_badge_16">
		<!-- Background for icon -->
		<svg class="member_type_badge_background_ura" width="18px" height="18px" viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
			<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
		...
		<svg class="member_type_badge_icon" width="18px" height="18px" viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
			<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
				...
				<h3>Signed in as</h3>
				<span id="user_menu_name">jkye96</span>
			</div>
		</div>
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/4975128411?crumb=s-1491548267-ac9649b6f1-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
...
<!-- END [include] 'inc_nav.txt' -->


	
	
<!-- BEGIN [include] 'inc_nav_team.txt' -->
					...
					<span class="block label">Help</span>
							...
							<span class="block label">Launch</span>
				                    ...
				                    <ul id="header_team_nav" data-qa="team_switcher_menu">
	                        	                            <li class="active">
	                            	<a href="https://tradingtechnologies.slack.com/home" target="https://tradingtechnologies.slack.com/">
	                            			                            			<i class="ts_icon small ts_icon_check_circle_o active_icon s"></i>
	                            			                            				                            		<i class="team_icon small" style="background-image: url('https://s3-us-west-2.amazonaws.com/slack-files2/avatars/2015-05-19/4976046929_9c8dc71b93dbe0a02ed0_88.jpg');"></i>
		                            		                            		<span class="switcher_label team_name">Trading Technologies</span>
	                            	</a>
	                            </li>
	                        	                            <li >
	                            	<a href="https://ilctrading.slack.com/home" target="https://ilctrading.slack.com/">
	                            			                            			                            			<i class="team_icon small default" >I</i>
	                            			                            		<span class="switcher_label team_name">ilctradingworkshop</span>
	                            	</a>
	                            </li>
...
<p class="print_only">
	...
	Created by John Alhadi on Thursday, April 6, 2017 at  11:51 PM
	</strong><br />
	<span class="subtle_silver break_word">https://tradingtechnologies.slack.com/files/jalhadi/F4VUX102Y/greeks.py</span>
</p>
...
<div class="file_public_link_shared alert" style="display: none;">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T04UP3SC3-F4VUX102Y-cd6edd4ac0" target="new">https://slack-files.com/T04UP3SC3-F4VUX102Y-cd6edd4ac0</a>
</div></div>
...
<div id="file_page" class="card top_padding">
	...
	<p class="small subtle_silver no_print meta">
		...
		8KB Python snippet created on <span class="date">April 6, 2017</span>.
	...
	<div class="large_bottom_margin clearfix">
		<pre id="file_contents">from algo_client import *
import vollib.black_scholes.implied_volatility as iv
import vollib.black_scholes.greeks.numerical as num
import math
...
class Greeks(object):
    ...
    def __init__(self, algo_client, contract, strikes, interest, time_to_expiry):
        ...
        self.spread = {strike: [0,0] for strike in self.strikes}
        ...
        try:
            ...
            for strike in self.strikes:
                ...
                if underlying[&quot;bids&quot;] and underlying[&quot;asks&quot;]:
                    ...
                    self.delta[strike][0] = delta(1, underlying_midpoint, strike, self.time_to_expiry, self.interest, call_vol)

                    put_vol = self.implied_vol[strike][1]
                    self.delta[strike][1] = delta(0, underlying_midpoint, strike, self.time_to_expiry, self.interest, put_vol)
        except:
            pass
        ...
        try:
            ...
            for strike in self.strikes:
                ...
                if underlying[&quot;bids&quot;] and underlying[&quot;asks&quot;]:
                    ...
                    call_vol = self.implied_vol[strike][0]
                    self.vega[strike][0] = vega(1, underlying_midpoint, strike, self.time_to_expiry, self.interest, call_vol)

                    put_vol = self.implied_vol[strike][1]
                    self.vega[strike][1] = vega(0, underlying_midpoint, strike, self.time_to_expiry, self.interest, put_vol)
        except:
            pass
    ...
    def update_spread(self):
        try:
            for strike in self.strikes:
                market_depth_call = self.algo_client.getMarketData(self.calls[strike], display=False)
                if market_depth_call[&quot;bids&quot;] and market_depth_call[&quot;asks&quot;]:
                    call_spread = market_depth_call[&quot;asks&quot;][0][&quot;p&quot;] - market_depth_call[&quot;bids&quot;][0][&quot;p&quot;]
                    self.spread[strike][0] = call_spread
                market_depth_put = self.algo_client.getMarketData(self.puts[strike], display=False)
                if market_depth_put[&quot;bids&quot;] and market_depth_put[&quot;asks&quot;]:
                    put_spread = market_depth_put[&quot;asks&quot;][0][&quot;p&quot;] - market_depth_put[&quot;bids&quot;][0][&quot;p&quot;]
                    self.spread[strike][1] = put_spread
        except:
            pass
...
<form action="https://tradingtechnologies.slack.com/files/jalhadi/F4VUX102Y/greeks.py"
		id="file_comment_form"
					class="comment_form clearfix"
				method="post">
			<a href="/team/jkye96" class="member_preview_link" data-member-id="U4J0Z6K2T" >
			<span class="member_image thumb_36" style="background-image: url('https://secure.gravatar.com/avatar/e72d8d3c43988e852c3a02746f3792a8.jpg?s=72&d=https%3A%2F%2Fa.slack-edge.com%2F66f9%2Fimg%2Favatars%2Fava_0021-72.png')" data-thumb-size="36" data-member-id="U4J0Z6K2T">
	<ts-icon class="member_type_badge member_type_badge_16">
		<!-- Background for icon -->
		<svg class="member_type_badge_background_ura" width="18px" height="18px" viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
	...
	<input type="hidden" name="crumb" value="s-1491548267-73f503baa8-☃" />
...
<!--
	...
	var boot_data = {
		...
		user_id: 'U4J0Z6K2T',
		no_login: false,
		version_ts: '1491536698',
		version_uid: '33d2e940f4182e74ee9d0e65ac0c104ebe2a913b',
		...
		api_url: '/api/',
		team_url: 'https://tradingtechnologies.slack.com/',
		image_proxy_url: 'https://slack-imgs.com/',
		beacon_timing_url: "https:\/\/slack.com\/beacon\/timing",
		beacon_error_url: "https:\/\/slack.com\/beacon\/error",
		clog_url: "clog\/track\/",
		api_token: 'xoxs-4975128411-154033223095-165233520753-b21f80dad1',
		ls_disabled: false,
		...
		feature_store_channels_in_redux: false,
		...
		feature_admin_profile_info: false,
		...
		feature_keyboard_support: false,
		...
		feature_improved_history_retries: false,
...
//-->
	...
	<!-- output_js "core" -->
<script type="text/javascript" src="https://a.slack-edge.com/dc231/js/rollup-core_required_libs.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/302b/js/rollup-core_required_ts.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/501f2/js/TS.web.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>

	<!-- output_js "core_web" -->
<script type="text/javascript" src="https://a.slack-edge.com/ee660d/js/rollup-core_web.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>

	<!-- output_js "secondary" -->
<script type="text/javascript" src="https://a.slack-edge.com/4866/js/rollup-secondary_a_required.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/ad5b/js/rollup-secondary_b_required.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>

			
	<!-- output_js "regular" -->
<script type="text/javascript" src="https://a.slack-edge.com/70b87/js/TS.web.comments.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/ca45d/js/TS.web.file.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/5d19/js/codemirror_load.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>


		<script type="text/javascript">
				TS.clog.setTeam('T04UP3SC3');
				TS.clog.setUser('U4J0Z6K2T');
			</script>
	...
	<!--
		...
		boot_data.file = {"id":"F4VUX102Y","created":1491540681,"timestamp":1491540681,"name":"greeks.py","title":"greeks.py","mimetype":"text\/plain","filetype":"python","pretty_type":"Python","user":"U4DQCP952","editable":true,"size":8116,"mode":"snippet","is_external":false,"external_type":"","is_public":false,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T04UP3SC3-F4VUX102Y\/greeks.py","url_private_download":"https:\/\/files.slack.com\/files-pri\/T04UP3SC3-F4VUX102Y\/download\/greeks.py","permalink":"https:\/\/tradingtechnologies.slack.com\/files\/jalhadi\/F4VUX102Y\/greeks.py","permalink_public":"https:\/\/slack-files.com\/T04UP3SC3-F4VUX102Y-cd6edd4ac0","edit_link":"https:\/\/tradingtechnologies.slack.com\/files\/jalhadi\/F4VUX102Y\/greeks.py\/edit","preview":"from algo_client import *\nimport vollib.black_scholes.implied_volatility as iv\nimport vollib.black_scholes.greeks.numerical as num\nimport math\n","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Efrom\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Ealgo_client\u003C\/span\u003E \u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-operator\"\u003E*\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Evollib\u003C\/span\u003E.\u003Cspan class=\"cm-property\"\u003Eblack_scholes\u003C\/span\u003E.\u003Cspan class=\"cm-property\"\u003Eimplied_volatility\u003C\/span\u003E \u003Cspan class=\"cm-keyword\"\u003Eas\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Eiv\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Evollib\u003C\/span\u003E.\u003Cspan class=\"cm-property\"\u003Eblack_scholes\u003C\/span\u003E.\u003Cspan class=\"cm-property\"\u003Egreeks\u003C\/span\u003E.\u003Cspan class=\"cm-property\"\u003Enumerical\u003C\/span\u003E \u003Cspan class=\"cm-keyword\"\u003Eas\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Enum\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Emath\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":172,"lines_more":167,"preview_is_truncated":true,"channels":[],"groups":["G4AF4C6CR"],"ims":[],"comments_count":1,"initial_comment":{"id":"Fc4VUX12G4","created":1491540681,"timestamp":1491540681,"user":"U4DQCP952","is_intro":true,"comment":"\u003C!here|@here\u003E \u003C!channel\u003E This should be the last update of the greeks code. It works the same as before. There aren't too many changes except that there is some extra error handling built in.","channel":""}};
		boot_data.file.comments = [{"id":"Fc4VUX12G4","created":1491540681,"timestamp":1491540681,"user":"U4DQCP952","is_intro":true,"comment":"\u003C!here|@here\u003E \u003C!channel\u003E This should be the last update of the greeks code. It works the same as before. There aren't too many changes except that there is some extra error handling built in.","channel":""}];
...
<!-- slack-www-hhvm-00ba37f66484a8ad0 / 2017-04-06 23:57:47 / v33d2e940f4182e74ee9d0e65ac0c104ebe2a913b / B:H -->
